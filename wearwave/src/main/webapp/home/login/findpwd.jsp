...
<div class="wrapper">
    <div class="wrap">
        ...
        <div class="find_wrap">
            <h3>등록된 전화번호로 찾기</h3>
            <form action="/login/findpwdbyphone.html" method="post">
           		<div class="input_box">
                    <label>아이디</label>
                    <input type="text" name="ID" class="input_field" placeholder="아이디를 입력하세요">
                </div>
                <div class="input_box">
                    <label>이름</label>
        ...
        <div class="find_wrap">
            <h3>등록된 이메일로 찾기</h3>
            <form action="/login/findpwdbyemail.html" method="post">
           		<div class="input_box">
                    <label>아이디</label>
                    <input type="text" name="ID" class="input_field" placeholder="아이디를 입력하세요">
                </div>
